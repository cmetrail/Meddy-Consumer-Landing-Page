...
export default function HowMeddyWorksSection() {
  return (
    <section id="how-it-works" className="relative w-full bg-[#17231D] text-white overflow-hidden">
      {/* ── Hero: How Meddy works ── */}
      <Hero />

      {/* ── Feature blocks ── */}
      <div className="flex flex-col py-10 pb-20 gap-20 md:gap-28 lg:gap-36">
        <NutritionSection />
        <GraphBand />
        <WorkoutSection />
        <FitnessTrend />
